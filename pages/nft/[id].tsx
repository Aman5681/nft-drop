  ...
  const mintNft = () => {
    ...
    nftDrop
      ...
      .then(async (tx) => {
        ...
        toast("HOORAY.. You Successfully Claimed Your NFT", {
          duration: 8000,
          style: {
            background: "green",
            color: "white",
    ...
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
      ...
      <div className="lg:col-span-4 bg-gradient-to-br from-cyan-800 to-rose-500">
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          <div className="rounded-xl bg-gradient-to-br from-yellow-400 to-purple-600 p-2">
            <img className="w-44 rounded-xl object-cover lg:h-96 lg:w-72" src={urlFor(collection.previewImage).url()} alt="ape" />
          </div>
      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0 lg:justify-center">
          ...
          {loading && <img className="h-80 w-80 object-contain" src="https://cdn.hackernoon.com/images/0*4Gzjgh9Y7Gu8KEtZ.gif" alt="" />}
        </div>
        ...
        >
          {loading ? <>Loading</> : claimedSupply === totalSupply?.toNumber() ? <>SOLD OUT</> : !address ? <>Sign in to Mint</> : <span className="font-bold">Mint NFT ({priceInEth} ETH)</span>}
        </button>
      </div>
    </div>
  );
